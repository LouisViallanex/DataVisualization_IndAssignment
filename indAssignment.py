...
axFM.pie([100*conducteurs['1']/sum(conducteurs.values()), 100*conducteurs['2']/sum(conducteurs.values())], colors=['#0984e3','#ff7675'], labels=['♂','♀'], wedgeprops = { 'linewidth' : 7, 'edgecolor' : '#5c5c5c' }, textprops={'color':"w"})

# Create a circle at the center of the plot
my_circle = plt.Circle( (0,0), 0.7, color='#5c5c5c')
p = plt.gcf()
p.gca().add_artist(my_circle)
axFM.set_title('Proportion of drivers by gender (2020)', color='white')
figFM.patch.set_facecolor('#5c5c5c')
...
fig3.patch.set_facecolor('#5c5c5c')
...
axs2[1].set_facecolor('#5c5c5c')
fig2.patch.set_facecolor('#5c5c5c')
